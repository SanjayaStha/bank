        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <form class="form-inline">
              ...
              <input class="form-control" size="18" type="search" placeholder="Search" aria-label="Search">
              <button class="btn btn-outline-success" type="submit">Search</button>
              </div>
              </form>
            </div>
            <div class="col-xs"><button type="button" class="btn btn-success"><i class="fas fa-globe "><span id="english" > English</span><span id="nepali"> नेपाली</span></i></button></div>
          </div>
        </div>
    <!-- </section> -->
